...
import { Users, BookOpen, DollarSign, Activity, FileBarChart, FileDown } from 'lucide-react'
...
// Mock datasets (moved from AdminAnalytics)
...
export default function AdminDashboard({ onNavigate }: AdminDashboardProps) {
  // State moved from analytics component
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <Card>
          <CardHeader className="pb-2"><CardTitle>Đăng ký khóa học theo thời gian</CardTitle></CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <Card>
          <CardHeader className="pb-2"><CardTitle>Tương tác người dùng theo ngày</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2"><CardTitle>Cảnh báo hệ thống</CardTitle></CardHeader>
